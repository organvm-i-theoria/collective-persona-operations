...
| [`recursive-engine`](https://github.com/organvm-i-theoria/recursive-engine--generative-entity) | The recursive structures that generate emergent properties also apply to persona: a persona is a recursive pattern of voice applied across contexts. |
